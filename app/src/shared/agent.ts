...
export const PUBLIC_URL_DISCOVERY_INSTRUCTIONS = [
  ...
  "When the Candidate's target roles are software, AI, or ML engineering, pass engineeringRolesOnly: true in the AshbyInspectJobs policy so the host excludes non-engineering postings (sales, operations, recruiting, legal) instead of returning them as include.",
